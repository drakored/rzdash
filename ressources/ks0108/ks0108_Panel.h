...
// you can swap around the elements below if your display is reversed
   ...
   byte chipSelect[] = {0B01, 0B10};        // this is for 128 pixel displays
#elif (DISPLAY_WIDTH / CHIP_WIDTH  == 3)
   //byte chipSelect[] = {0B00, 0B01, 0B10};  // this is for 192 pixel displays
   byte chipSelect[] = {0B00, 0B10, 0B01};  // this is for 192 pixel displays on sanguino only
#endif
...
#define EN_DELAY_VALUE 10 // this is the delay value that may need to be hand tuned for slow panels (original 6)
